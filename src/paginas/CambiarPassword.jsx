...
const CambiarPassword = () => {
  ...
  const handleSubmit=async e=>{
    ...
    const respuesa=await guardarPassword(password)
    setAlerta(respuesa)
  }
              ...
              {msg && <Alerta alerta={alerta}/>}
                <div className='my-3'>
                    ...
                    <input
                        ...
                        name="pwd_actual"
                        placeholder='Coloca tu password acutal'
                ...
                <input
                    ...
                    className='bg-indigo-700 px-10 py-3 font-bold text-white rounded-lg uppercase w-full mt-5 mb-5'
                    // onClick={()=>actualizarPerfil(perfil)}
                />
                  {/* {msg && <Alerta alerta={alerta}/>} */}
            </form>
